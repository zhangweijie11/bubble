(function (e) {
    ...
    0: function (e, t, n) {
        ...
        var o = n("2b0e"), r = (n("d3b7"), n("bc3a")), a = n.n(r), s = {},
            i = a.a.create(s);
        ...
        var l = function () {
                ...
                }, [n("div", {staticClass: "grid-content"}, [n("el-divider", [n("h1", [e._v("bubble清单")])]), n("TodoList")], 1)])], 1)], 1), n("el-footer", [e._v("gin 框架简单示例")])], 1)
            }, d = [], f = function () {
                var e = this, t = e.$createElement, n = e._self._c || t;
            ...
            b = Object(w["a"])(v, f, p, !1, null, null, null), m = b.exports,
            ...
            T = (n("034f"), Object(w["a"])(O, l, c, !1, null, null, null)), P = T.exports,
            $ = n("5c96"), k = n.n($);
        n("0fae");
        o["default"].use(k.a);
        var C = n("8c4f");
        o["default"].use(C["a"]);
        var D = [{path: "/", name: "index", component: j}], S = new C["a"]({routes: D}),
            E = S;
